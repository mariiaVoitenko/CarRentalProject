...
import ua.nure.voitenkom.SummaryTask4.service.locale.SessionLocaleService;
...
public class LocaleServiceContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent context) {
        ...
        LocaleService localeService = getLocaleService(localeServiceType, appLocales, new Locale(defaultLocale));
    ...
    private LocaleService getLocaleService(String localeServiceType, List<String> appLocales, Locale defaultLocale) {
        ...
        switch (localeServiceType) {
            case "Session":
                return new SessionLocaleService(appLocales, defaultLocale);
            case "Cookie":
                return new CookieLocaleService(appLocales, defaultLocale, cookieTimeout);
            default: {
